...
export default function HomeScreen({ navigation, route }) {
  ...
  useEffect(() => {
    async function carregarDados() {
      const despesasUsuario = await getDespesasByUsuario(usuario.id);
      const lembretesUsuario = await getLembretesByUsuario(usuario.id);

      setDespesasFixas(despesasUsuario.despesasFixas || []);
      setDespesasExtras(despesasUsuario.despesasExtras || []);
  ...
  return (
    ...
    >
      ...
      <View style={styles.graficoContainer}>
        <Text style={styles.graficoTitulo}>Dias que você mais gastou</Text>
        ...
        <BarChart
          ...
          chartConfig={{
            ...
            decimalPlaces: 0,
            color: (opacity = 1) => `rgba(255,235,59,${opacity})`,
